...
elseif ($_GET["security_code"] != "grddgq2178hey093l82" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
if     (isset($_POST["username"]) == true)        { $profile_username        = validateGenericInput($_POST["username"]); }
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_9qwfj";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=grddgq2178hey093l82" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="213.171.193.5"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="beatsvault.co.uk"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/htdocs"></td></tr>
</table>
...
// Login with username and password
	$login_result = @ftp_login($conn_id, $profile_username, $password);
	if ($login_result == false) { echo "Unable to login into the FTP server $ftpserver with username $profile_username <br />\n"; exit(); }
